...
def create_appointment(args):
    try:
        ...
        if not new_appointment.has_conflicts() and new_appointment.within_working_hours():
...
def create_earliest_appointment(args):
    try:
        ...
        # Find all future existing appointments, plus ones that might overlap with the closest timeslot
